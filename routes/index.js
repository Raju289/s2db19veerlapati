...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Heroine App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Heroine App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Heroine App Login', user : req.user }); 
}); 
